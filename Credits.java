...
public class Credits extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(461, 415));
        ...
        jLabel2.setText("Τσάτσο Κρισέλντα");

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 20)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("kriseltsatso@gmail.com");
        ...
        jLabel4.setText("Send me your opinion for our app!");
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/teliko/redback.png"))); // NOI18N
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
       ...
       if (jTextArea1.getText().trim().isEmpty()){
           JOptionPane.showMessageDialog(null,"You didn't write anything. Try again!");  
       }
       else{
        if (clickCount == 0) {
            jButton1.setText("Sended!");
            jTextArea1.setText("");
